export const SITE_NAME = "QualityPacks";
export const SITE_TAGLINE = "Premium Quality Packs";
export const SITE_DESCRIPTION = "Explore our curated selection. Add to cart and submit your order.";

export const CATEGORIES = ["All", "Exotic", "Premium", "Classic"];
