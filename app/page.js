  ...
  return (
    <div>
      <header style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(10,10,15,.88)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderBottom: "1px solid var(--border)", padding: "0 24px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }} onClick={() => { setPage("shop"); setSelectedProduct(null); }}>
            <div style={{ width: 36, height: 36, borderRadius: 10, background: "linear-gradient(135deg, var(--accent), #8b5cf6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, fontWeight: 800, color: "#fff", boxShadow: "0 4px 16px var(--accent-glow)" }}>Q</div>
            <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 20 }}>Quality<span style={{ color: "var(--accent)" }}>Packs</span></span>
          </div>
      ...
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 24px 80px" }}>
        {loading && (<div style={{ textAlign: "center", padding: 80, color: "var(--muted)" }}><div style={{ fontSize: 40, marginBottom: 16 }}>⏳</div><p>Loading products...</p></div>)}
        ...
        {page === "shop" && !loading && (
          <>
            ...
            {products.length === 0 && (<div style={{ textAlign: "center", padding: 60, color: "var(--muted)" }}><p style={{ fontSize: 40, marginBottom: 12 }}>🏪</p><p>No products listed yet. Check back soon!</p></div>)}
        ...
        {page === "cart" && (
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            <button onClick={() => setPage("shop")} style={{ display: "flex", alignItems: "center", gap: 8, background: "none", border: "none", color: "var(--muted)", cursor: "pointer", fontSize: 14, marginBottom: 20 }}>← Back to Shop</button>
            ...
            {cart.length === 0 ? (
              ...
              <>
                ...
                {copied && (<p style={{ textAlign: "center", marginTop: 12, fontSize: 13, color: "var(--green)", animation: "fadeUp .3s ease" }}>✓ Paste into Telegram or Signal to submit your order</p>)}
