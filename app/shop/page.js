        ...
        {page==="cart"&&<div style={{maxWidth:800,margin:"0 auto"}}>
          ...
          :<>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:12}}>
              ...
              {sigLink&&<button onClick={()=>{window.open(sigLink,"_blank");copyOrd();}} style={{width:"100%",padding:"16px",borderRadius:14,border:"none",background:"linear-gradient(135deg,#3a76f0,#2958b5)",color:"#fff",fontSize:16,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:10}}><svg width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 4.5c4.142 0 7.5 3.358 7.5 7.5s-3.358 7.5-7.5 7.5S4.5 16.142 4.5 12 7.858 4.5 12 4.5z"/></svg>Send Order on Signal</button>}
            </div>
